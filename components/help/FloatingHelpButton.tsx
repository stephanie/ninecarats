  ...
  return (
    <div className="fixed bottom-6 right-6 z-40">
      ...
      <button
        ...
        className="group bg-primary-dark text-white relative rounded-full p-3 shadow-sm shadow-primary-dark hover:shadow-xl transition-all duration-300 ease-out hover:scale-105 cursor-pointer"
